...
public class Tablero extends JFrame implements ActionListener {
	...
	private boolean x;
	private MiBoolean stop1, stop2, stop3;
	private int a, b;
	...
	public Tablero() {
		...
		this.stop1 = new MiBoolean(false);
		this.stop2 = new MiBoolean(false);
		this.stop3 = new MiBoolean(false);
				...
				if(e.getSource() == this.botones[i][j]) {
					if(x) {
						...
						if(state.exist_move(state.move(a+1, b+1, i+1, j+1))) {
							...
							State s1 = new State(state.clone_board(), false);
							State s2 = new State(state.clone_board(), false);
							State s3 = new State(state.clone_board(), false);
							...
							exec1.submit(() -> {
								...
								State min_max = s1.getMinMax(4, stop1);
							...
							exec2.submit(() -> {
								...
								State min_max = s2.getMinMax(5, stop2);
							...
							exec3.submit(() -> {
								...
								State min_max = s3.getMinMax(6, stop3);
